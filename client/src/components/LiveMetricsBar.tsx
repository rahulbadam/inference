...
export default function LiveMetricsBar() {
  ...
  const items = [
    ...
    { label: "VRAM", value: `${metrics.memoryUsed}/${metrics.memoryTotal}GB`, tip: "vram", icon: <Activity size={14} className="text-accent-purple" />, color: metrics.memoryUsed > metrics.memoryTotal * 0.9 ? "text-accent-red animate-pulse" : "text-accent-purple" },
